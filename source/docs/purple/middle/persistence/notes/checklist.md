...
endpoint agent should be investigated.
...
baseline date should be investigated.
...
Any key not matching known administrative keys should be removed and
investigated.
...
- PHP/ASPX files in upload directories (these should never be executable)
