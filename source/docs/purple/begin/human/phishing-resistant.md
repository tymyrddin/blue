...
and enforced](../../../diy/mailserver/index.rst), prevent attackers from sending email that appears to originate from a domain the
...
Plus, most phishing training teaches people to spot last year’s attacks, leaving staff confident against fake 
threats while real campaigns slip through, such as QR codes in PDFs, credential harvesting on legitimate cloud 
services, and MFA bypasses. The best approach combines occasional purple team sessions for hands-on attacker and 
defender practice with monthly simulations running through live defences, using current threat intelligence. 

Staff see results in real time, practise responses, and metrics track clicks, reports, and filter effectiveness. 
[The goal is not zero clicks but fast detection, consistent reporting, and continuous learning](../../../ngo/awareness/attack-simulation.md). 
