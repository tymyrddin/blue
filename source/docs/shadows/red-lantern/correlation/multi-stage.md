...
This is late-stage detection, but still actionable: traffic can be rerouted, prefixes filtered, and trust anchors audited. For response actions when this alert fires, see [Playbook 2](../response/playbooks.md).
