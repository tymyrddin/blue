# Intercepted note Scarlet Semaphore (pinned, then unpinned)
...
- If you cannot undo it, do not do it
- If you cannot explain it, definitely do not do it
- If the city notices, you have done it wrong

The point is to learn how trust moves, not to prove you are clever. We already assume that.
