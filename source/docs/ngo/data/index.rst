...
room and a retained forensics firm. The goal is to have answers to three questions before an incident happens rather
than during it:

.. toctree::
   :maxdepth: 1
   :caption: Who do we call, what do we do immediately, and what do we need to report to whom?
