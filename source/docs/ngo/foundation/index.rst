...
In a mid-sized non-profit that has grown organically, the answer is usually uncomfortable.
Shared accounts. Former employees with lingering access. An admin or two who are the only ones
who know the passwords, stored in their head, or in a spreadsheet, or on a sticky note that was
definitely deleted. MFA rolled out for some people. Conditional Access policies that exist in
draft form and have never been enforced.

.. toctree::
   :maxdepth: 1
   :caption: Laying the groundwork.
