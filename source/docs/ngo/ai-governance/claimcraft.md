...
validates eligibility, flags errors, and formats the HMRC batch submission. What
...
current addresses, donation amounts, dates, and HMRC reference numbers for each valid
...
amounts, and HMRC references formed a dataset where each row contained enough linked
...
submissions for 340 UK charities. Their infrastructure ran on a cloud provider whose
servers were, as the business analyst eventually established after several rounds of
email, located in Ireland and the United States. The data that crossed from Ireland to
the United States was covered, ClaimCraft assured the IT manager, by Standard
Contractual Clauses.
...
one person who also managed ClaimCraft's HMRC accreditation. The SCCs arrived eleven
...
been submitted to HMRC. The process had worked exactly as advertised. The finance
...
release on LinkedIn. ClaimCraft AI had been acquired by Meridian Data Services, a
data analytics company that described its business as "enriching and activating donor
intelligence across the third sector." Meridian's product portfolio included a charity
...
assets would transfer to Meridian as part of the transaction.
...
The 38,000 donor records, including the gift aid declarations with amounts and HMRC
references, were now in the possession of a company whose primary business was selling
donor intelligence to the charity sector. Meridian's terms of service, updated post-
...
The DPO sent a formal data subject request to Meridian asking for confirmation of what
data they held relating to the Home's donors, under what legal basis it was held, and
whether it had been used to train or enrich any Meridian product.

Meridian's response confirmed that historical ClaimCraft processing data was retained
...
ClaimCraft's vacancy for a Data Protection Officer had been open on LinkedIn throughout
