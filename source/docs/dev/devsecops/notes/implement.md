...
* Formalise processes for security activities within an SSI. After starting a program or standard, it is essential to spend an operational period helping engineers get familiarised with it and gather feedback before enforcing it. When performing a gap analysis, every policy benefits from defined procedures to make it effective.
