...
Applying the [fundamentals of iOS forensics](../../../dfir/notes/ios.md) for analysing an actual iPhone in "Operation JustEncase": 
...
Although the suspect's phone is locked with a passcode, you have been able to use a recent "Lockdown Certificate" from the suspect's computer, allowing you to create a [logical file system dump from an iPhone backup he made recently](../../../dfir/notes/ios.md). 
