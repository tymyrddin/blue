...
This [static analysis sample case study](../../../dfir/notes/mobile-analysis.md) is for a trojanised application uploaded in Pithus (online analysis). The sample for local analysis with `jadx` can be [downloaded here](https://pts-project.org/samples/sample_1.zip).
