...
A common defence tactic is to block, drop, or deny inbound requests from IP addresses on your parameter or external 
...
Domain names are slightly more of a pain to change, because in order to work, they need to be registered, paid for 
