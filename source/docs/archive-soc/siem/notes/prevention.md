...
Just a few notes. Because incident response is a cyclical process, preparation and prevention are considered before and after an incident. Before, to ensure something does not happen; after, to ensure it does not happen again.
...
Approach host security with the principle of least privilege: privileges based solely on the host's authorised tasks, keeping each host at the lowest level needed for its work.
