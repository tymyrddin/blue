...
* Modern OpenVPN (2.4+) defaults to ECDH and does not require a static DH parameters file. If using a custom DH parameters file generated with `easyrsa gen-dh`, update the `dh` directive to point to `dh.pem`.
