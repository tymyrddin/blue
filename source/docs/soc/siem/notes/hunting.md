...
2. During the investigation phase, threat hunters use technology such as [Endpoint Detection and Response (EDR)](../../edr/index.rst) to take a deep dive into potential malicious compromise of a system. 
