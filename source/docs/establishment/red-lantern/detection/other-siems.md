...
The Establishment cannot provide exhaustive coverage of every platform (budget reality meets best practice), but 
enough is offered here to get started. The patterns from the [generic detection section](generic.md) remain your foundation. 
...
Choosing a SIEM platform involves more than detection syntax. The Establishment has operated multiple 
...
The Establishment runs Wazuh for cost efficiency but acknowledges that larger organisations often operate multiple SIEM 
