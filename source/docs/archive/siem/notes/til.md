...
Once the information aggregation is complete, analysts draw insights from the data. Decisions to be made may involve:
...
the threat intelligence process and implementation of security controls. Regular interaction between teams keeps the lifecycle working.
